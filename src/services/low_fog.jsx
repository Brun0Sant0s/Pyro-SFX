...
import img1 from "../assets/services/low_fog_1.png";
import img2 from "../assets/services/low_fog_2.png";
import img3 from "../assets/services/low_fog_3.png";

const highlights = [
  { icon: CloudFog, title: "Nevoeiro Rente", desc: "Mant\u00e9m-se no ch\u00e3o." },
  { icon: Film, title: "Aspeto Cinematogr\u00e1fico", desc: "Ideal para entradas e valsas." }
];

export default function LowFog({ meta }) {
  const { label, imgMain } = meta;

  const description = "Tapete de nevoeiro rente ao chão que não sobe. Visual cinematográfico para entradas, valsas e momentos “first dance”.";
