...
import img1 from "../assets/services/espuma_1.png";
import img2 from "../assets/services/espuma_2.png";
import img3 from "../assets/services/espuma_3.png";

const highlights = [
  { icon: Waves, title: "Alto Volume", desc: "Cobertura r\u00e1pida da \u00e1rea." },
  { icon: ShowerHead, title: "Limpeza F\u00e1cil", desc: "Produto de f\u00e1cil remo\u00e7\u00e3o." }
];

export default function Espuma({ meta }) {
  const { label, imgMain } = meta;

  const description = "Canhões de espuma de alto caudal que criam uma zona imersiva e divertida. Caudal regulável e produto de fácil limpeza para eventos outdoor.";
