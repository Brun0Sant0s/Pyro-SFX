...
import img1 from "../assets/services/neve_1.png";
import img2 from "../assets/services/neve_2.png";
import img3 from "../assets/services/neve_3.png";

const highlights = [
  { icon: Snowflake, title: "Floco Seco", desc: "N\u00e3o molha nem cola." },
  { icon: Wind, title: "Cobertura Ampla", desc: "Espalha-se uniformemente." }
];

export default function Neve({ meta }) {
  const { label, imgMain } = meta;

  const description = "Neve artificial de floco seco que não molha nem cola. Cobertura homogénea e leitura perfeita em foto e vídeo.";
