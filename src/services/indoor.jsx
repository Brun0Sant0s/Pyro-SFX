...
import img1 from "../assets/services/indoor_1.png";
import img2 from "../assets/services/indoor_2.png";
import img3 from "../assets/services/indoor_3.png";

const highlights = [
  { icon: Home, title: "Certificado Indoor", desc: "Efeitos aprovados para interior." },
  { icon: ShieldCheck, title: "Montagem Segura", desc: "Per\u00edmetros e t\u00e9cnicos qualificados." }
];

export default function Indoor({ meta }) {
  const { label, imgMain } = meta;

  const description = "Gerbs, flashes e minas certificados para interiores. Integração com DMX/timecode e perímetros claros para impacto e segurança.";
