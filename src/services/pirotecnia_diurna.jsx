...
import img1 from "../assets/services/pirotecnia_diurna_1.png";
import img2 from "../assets/services/pirotecnia_diurna_2.png";
import img3 from "../assets/services/pirotecnia_diurna_3.png";

const highlights = [
  { icon: Sun, title: "Vis\u00edvel ao Sol", desc: "Efeito forte em pleno dia." },
  { icon: Palette, title: "Cores Vibrantes", desc: "Fumos e cartuchos coloridos." }
];

export default function PirotecniaDiurna({ meta }) {
  const { label, imgMain } = meta;

  const description = "Efeitos visíveis à luz do dia com fumos e cores vibrantes. Ideal para cerimónias, desfiles e eventos desportivos.";
