...
import { ArrowDownToLine, Flag } from "lucide-react";

import img1 from "../assets/services/power_drop_1.png";
import img2 from "../assets/services/power_drop_2.png";
import img3 from "../assets/services/power_drop_3.png";

const highlights = [
  { icon: ArrowDownToLine, title: "Queda Precisa", desc: "Cue exato e controlado." },
  { icon: Flag, title: "Revela\u00e7\u00e3o Limpa", desc: "Palco/brand vis\u00edvel de imediato." }
];

export default function PowerDrop({ meta }) {
  const { label, imgMain } = meta;

  const description = "Sistema de queda de cortina/bandeira milimétrico para revelação imediata. Preparação discreta e ativação segura no cue exato.";
