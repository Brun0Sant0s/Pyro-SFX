...
import img1 from "../assets/services/bolhas_1.png";
import img2 from "../assets/services/bolhas_2.png";
import img3 from "../assets/services/bolhas_3.png";

const highlights = [
  { icon: Droplets, title: "Fluxo de Bolhas", desc: "Milhares de bolhas por minuto." },
  { icon: Sparkles, title: "Ambiente Festivo", desc: "Efeito m\u00e1gico em luz de palco." }
];

export default function Bolhas({ meta }) {
  const { label, imgMain } = meta;

  const description = "Ambiente lúdico e fotogénico com milhares de bolhas em cena. Ideal para ativações de marca, eventos familiares e momentos de transição com luz de palco.";
